...
import 'package:mr_techie/pages/PostScreenPage.dart';
...
class _NotificationsPageState extends State<NotificationsPage> {
 ...
 retriveNotifications() async
 {
   ...
   List<NotificationsItem> notifcationsItems = [];

   querySnapshot.documents.forEach((document){
     notifcationsItems.add(NotificationsItem.fromDocument(document));
    });

   return notifcationsItems;
...
class NotificationsItem extends StatelessWidget
 {
   ...
   NotificationsItem({this.username, this.type, this.commentData, this.postId, this.userId, this.userProfileImage, this.url, this.timestamp});
  ...
  if(type == "like")
   ...
   {
     notificationItemText = "strated following you.";
   }
   else 
   {
