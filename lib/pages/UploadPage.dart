...
class _UploadPageState extends State<UploadPage>  with AutomaticKeepAliveClientMixin<UploadPage>
 {
   ...
   displayUploadScreen(){
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Icon(Icons.add_photo_alternate, color: Colors.grey, size:180.0),
            Padding(
  ...
  getUserCurrentLocation() async {
    ...
    String completeAddressInfo = "${nPlaceMark.subThoroughfare} ${nPlaceMark.thoroughfare}, ${nPlaceMark.subLocality} ${nPlaceMark.locality}, ${nPlaceMark.subAdministrativeArea} ${nPlaceMark.administrativeArea}, ${nPlaceMark.postalCode} ${nPlaceMark.country}";
    String specificAddress = "${nPlaceMark.subLocality} ${nPlaceMark.locality},  ${nPlaceMark.country}";
  ...
  compressingPhoto() async {
    ...
    final compressedImageFile = File('$path/img_$postId.jpg')..writeAsBytesSync(InD.encodeJpg(nImageFile,quality:60));
    setState(() {
  ...
  Future<String> uploadPhoto(nImagefile) async{
    StorageUploadTask nStorageUploadTask = storageReference.child("post_$postId.jpg").putFile(nImagefile);
    StorageTaskSnapshot storageTaskSnapshot = await nStorageUploadTask.onComplete;
    String downloaUrl = await storageTaskSnapshot.ref.getDownloadURL();
    return downloaUrl;
   ...
   displayUploadFormScreen(){
     return Scaffold(
       appBar: AppBar(
         ...
         title: Text("New Post", style: TextStyle(fontSize: 20.0, color: Colors.white, fontWeight: FontWeight.bold),),
         actions: <Widget>[
           FlatButton(
